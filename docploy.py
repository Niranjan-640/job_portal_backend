...
API_URL = "http://13.233.144.63:3000/api/project.all"
api_key = "nIXRRJUVYUaSDlVJZAvidEUCGfcboCOFBKkBSDYocfXbuCKuKfLHgsAehiyDzQDY"
app_name = "jobportal-backend-iqx437"
